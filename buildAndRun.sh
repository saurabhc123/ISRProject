...
spark-submit  --driver-memory 20G --jars stanford-corenlp/jars/stanford-corenlp-3.4.1-models.jar,stanford-corenlp/jars/stanford-corenlp-3.4.1.jar,hbase-rdd_2.10/jars/hbase-rdd_2.10-0.7.1.jar --class isr.project.SparkGrep target/scala-2.10/sparkgrep_2.10-1.0.jar "$1" 9 "$2"
